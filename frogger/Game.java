 ...
 * @version 0.4 (November 29, 2012) This is the "controller" of the MVC
 *          architecture
 */
public class Game extends JFrame implements ActionListener {
  ...
  public Game() {
    ...
    mItem = new JMenuItem(aboutCommand);
    fileMenu.add(mItem);
    mItem = new JMenuItem(quitCommand);
    fileMenu.add(mItem);
    JMenu commandMenu = new JMenu("Commands");
    mItem = new JMenuItem(gameTickCommand);
    ...
    deleteButton = new JButton(deleteCommand);
    ...
    quitButton = new JButton(quitCommand);
   ...
   * windowClosing(WindowEvent e) { setAction(quitCommand); } } );
   */
