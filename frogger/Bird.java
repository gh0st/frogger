...
public class Bird extends MovingGameObject implements IDrawable, ICollider {
  ...
  public Bird() {
    ...
    int x = getRandom(100, 900);
    int y = getRandom(425, 475);
    setLocation(x, y);
  ...
  public void update() {
    ...
    /*
     * if (leftWingOffsetSx <= leftWingMaxOffsetSx) //leftWingIncrementSx *=
     * 1/leftWingIncrementSx; leftWingOffsetSx += leftWingIncrementSx; else if
     * (leftWingOffsetSx >= leftWingMaxOffsetSx) leftWingOffsetSx *=
     * (1/leftWingIncrementSx);
     */
