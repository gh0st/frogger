...
public class GameWorld implements IObservable, IGameWorld {
	...
	/*private int carCount; // tracks how many cars are in the world
	private int logCount; // tracks how many logs are in the gameworld
	private int truckCount; // tracks how many trucks are in the gameworld
	private int turtleCount; // tracks how many turtles are in the gameworld*/
	...
	/**
	 * Adds the given Observer to the ObserverList so that when the observer
	 * needs to be notified the list is iterated through and the Observers are 
	 * notified.
	...
	/**
	 * Notify the observers that the gameworld has changed but because we don't 
	 * want the observers to be able to modify any of the gameworld directly
	 * we'll create a GameWorldProxy that contains all the elements and methods
	 * that the GameWorld contains but the set() methods do not contain a body.
	 */
